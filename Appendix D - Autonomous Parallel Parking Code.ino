const int trigPin = 5;  //pin 5 connected to the trigger pin of the HC-SR04
const int echoPin = 18;  //pin 18 connected to the echo pin of the HC-SR04
...
void loop()
{
 ...
 //Reverse and rotate 90 degrees
  ...
  servoAngle = 55;
  Transmit_to_arduino(leftMotor_speed, rightMotor_speed, servoAngle);  //transmit data to arduino
  while (angle >= -165  ) {  //loop until angle is less than or equal to -165
    angle = accelerometer();  //get angle from accelerometer
  }
